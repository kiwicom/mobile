...
const FastTrackVocabulary = {
  'mmb.fast_track.banner.title.bergamo.bergamo_stopover': 'Milan Bergamo Stopover Bundle',
  ...
  'mmb.fast_track.banner.services_label.bergamo.bergamo_stopover': 'Services included',
  ...
  'mmb.fast_track.banner.show_qr_button.bergamo.bergamo_stopover': 'Show QR Code',
  'mmb.fast_track.banner.close_modal_button.bergamo.bergamo_stopover': 'Close modal',
};
